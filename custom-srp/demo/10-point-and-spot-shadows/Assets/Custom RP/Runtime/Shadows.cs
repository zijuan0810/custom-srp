...
public class Shadows
{
    ...
    public void Render()
    {
        ...
        if (shadowedOtherLightCount > 0)
            ...
            buffer.SetGlobalTexture(otherShadowAtlasId, new RenderTargetIdentifier(dirShadowAtlasId));
    ...
    void RenderOtherShadows()
    {
        ...
        buffer.SetRenderTarget(new RenderTargetIdentifier(otherShadowAtlasId), RenderBufferLoadAction.DontCare,
            RenderBufferStoreAction.Store);
        buffer.ClearRenderTarget(true, false, Color.clear);
        buffer.BeginSample(bufferName);
        ExecuteBuffer();
